...
{
    [LocalizedDisplayName(nameof(Resources.DeleteAgreement_DisplayName))]
    [LocalizedDescription(nameof(Resources.DeleteAgreement_Description))]
    public class DeleteAgreement : ContinuableAsyncCodeActivity
    {
        #region Properties
        ...
        [LocalizedDisplayName(nameof(Resources.DeleteAgreement_AgreementId_DisplayName))]
        [LocalizedDescription(nameof(Resources.DeleteAgreement_AgreementId_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        public InArgument<string> AgreementId { get; set; }

        [LocalizedDisplayName(nameof(Resources.DeleteAgreement_Response_DisplayName))]
        [LocalizedDescription(nameof(Resources.DeleteAgreement_Response_Description))]
        ...
        {
            Constraints.Add(ActivityConstraints.HasParentType<DeleteAgreement, AdobeSignScope>(string.Format(Resources.ValidationScope_Error, Resources.AdobeSignScope_DisplayName)));
        }
        ...
        protected override async Task<Action<AsyncCodeActivityContext>> ExecuteAsync(AsyncCodeActivityContext context, CancellationToken cancellationToken)
        {
            ...
            string StateReposnse = await adobeObject.DeleteAgreement(agreementId);
            response = true;
            // Outputs
            return (ctx) => {
