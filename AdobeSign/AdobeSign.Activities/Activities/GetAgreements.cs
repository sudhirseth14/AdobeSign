...
{
    [LocalizedDisplayName(nameof(Resources.GetAgreements_DisplayName))]
    [LocalizedDescription(nameof(Resources.GetAgreements_Description))]
    public class GetAgreements : ContinuableAsyncCodeActivity
    {
        #region Properties
        ...
        [LocalizedDisplayName(nameof(Resources.GetAgreements_UserAgreements_DisplayName))]
        [LocalizedDescription(nameof(Resources.GetAgreements_UserAgreements_Description))]
        [LocalizedCategory(nameof(Resources.Output_Category))]
        public OutArgument<string> UserAgreements { get; set; }
        ...
        {
            Constraints.Add(ActivityConstraints.HasParentType<GetAgreements, AdobeSignScope>(string.Format(Resources.ValidationScope_Error, Resources.AdobeSignScope_DisplayName)));
        }
        ...
        protected override async Task<Action<AsyncCodeActivityContext>> ExecuteAsync(AsyncCodeActivityContext context, CancellationToken cancellationToken)
        {
            ...
            string userAgreements = await adobeObject.GetAgreements();

            // Outputs
            return (ctx) => {
                UserAgreements.Set(ctx, userAgreements);
            };
        }
